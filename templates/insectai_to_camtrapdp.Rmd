...
This script serves as a template for mapping raw data Camera Trap Data Package (Camtrap DP), with the current suggested changes proposed by the InsectAI community.
